...
data class PrinterDetailLabels(
    ...
    val hmsAlertSeverity: HmsSeverity,
    ...
    val wifiSignalLevel: WifiSignalLevel? = null,
...
fun PrinterStatus.toDetailLabels(
    ...
    return PrinterDetailLabels(
        ...
        hmsSummary = formatHmsSummary(resolveHmsAlertSeverity()),
        nozzleTemp = formatTemp(nozzleTemp),
        bedTemp = formatTemp(bedTemp),
        hmsHealth = formatHmsHealth(resolveHmsAlertSeverity()),
        hmsHasErrors = resolveHmsAlertSeverity() != HmsSeverity.Ok,
        hmsAlertSeverity = resolveHmsAlertSeverity(),
        ...
        wifiSignalLevel = resolveWifiSignalLevel(wifiSignalDbm, wiredNetwork),
